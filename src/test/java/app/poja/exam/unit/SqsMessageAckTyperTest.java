...
import app.poja.exam.endpoint.event.EventConsumer;
import app.poja.exam.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("app.poja.exam.endpoint.event.gen.UuidCreated", payload);
